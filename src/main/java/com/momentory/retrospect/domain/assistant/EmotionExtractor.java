...
/**
 * 감정 추출 포트 — 일기 작성 대화 전체에서 감정을 뽑아 {@link ExtractedEmotion} 목록으로 준다.
 *
 ...
 *
 * <p>실패하면 빈 목록을 준다 — 감정 슬롯을 못 채운 것으로 두고 흐름은 계속된다(던지지 않는다).
 */
@FunctionalInterface
public interface EmotionExtractor {

    List<ExtractedEmotion> extract(RetrospectState state);
}
