...
/**
 * 일기 한 벌 조회 응답 — 목록의 항목이자 단건 조회의 본체. 목록도 전체 본문({@code original})을
 * 그대로 담는다.
 *
 * <p>본문은 {@code original} 하나다(채팅흐름_v2 에서 리프레임 본문을 없앴다). 행동 카드는
 * {@code retrospectId} 로 {@code GET /retrospect/{id}/diary} 에서 가져온다.
 */
